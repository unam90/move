...
X, y = make_blobs(n_samples=50, centers=2, cluster_std=0.5, random_state=4)  # random_state 값을 바꾸면 support vector값도 달라짐 
y = 2 * y - 1
...
model = SVC(kernel='linear', C=1.0).fit(X, y)  # tuning parameter값을 변경해보자.
